<?php
	...
	$pages = array(
		'0'	=> array('id' => '1', 'alias' => 'Strona-główna', 'file' => '1.php'),
		'1'	=> array('id' => '2', 'alias' => 'O-nas', 'file' => '2.php'),
		'2'	=> array('id' => '4', 'alias' => 'Partnerzy', 'file' => '4.php'),
		'3'	=> array('id' => '3', 'alias' => 'Kontakty', 'file' => '3.php')
	);
	$forms = array(
		'3'	=> array(
			'b3c69edd' => Array( 'email' => '', 'emailFrom' => '', 'subject' => 'Inquiry from the web page', 'sentMessage' => 'Fomularz został wysłany.', 'object' => '', 'objectRenderer' => '', 'loggingHandler' => '', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'recSiteKey' => null, 'recSecretKey' => null, 'fields' => array( array( 'fidx' => '0', 'name' => 'Nazwa', 'type' => 'input', 'options' => '' ), array( 'fidx' => '1', 'name' => 'E-mail', 'type' => 'input', 'options' => '' ), array( 'fidx' => '2', 'name' => 'Wiadomość', 'type' => 'textarea', 'options' => '' ) ) )
		)
	);
	$langs = null;
	$def_lang = null;
